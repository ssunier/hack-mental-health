...
*/
  var predict = function(good_mood_tm, poor_mood_tm, event_nm, event_tm) {
    ...
    for (var j = 0; j<score.length; j++) {
      ...
      switch (activity) {
        case "poor_sleep":
          $('#p0').data('rank', score[j][0]); //score
          break;
        case "good_sleep":
          $('#p1').data('rank', score[j][0]); //score
          break;
          case "poor_exercise":
          $('#p2').data('rank', score[j][0]); //score
          break;
        case "good_exercise":
          $('#p3').data('rank', score[j][0]); //score
          break;
        case "poor_browsing":
          $('#p4').data('rank', score[j][0]); //score
          break;
        case "good_browsing":
          $('#p5').data('rank', score[j][0]); //score
          break;
        }
      }
